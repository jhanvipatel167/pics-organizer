...
def main():
    ...
    for filename in glob.iglob(input_files_pattern, recursive=True):
        ...
        if image_datetime:
            ...
            '''
            -check if output filename already exists in images_organized
                -if its there then compare the file sizes to be sure we are dealing with different images
                ...
                -if its not there, 
                    -add the output_filename in image_organized set
